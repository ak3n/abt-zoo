...
(* OASIS_START *)
(* DO NOT EDIT (digest: 39a6d5c037e5850946fc719f4ff8cb5c) *)
(*
...
let setup_t =
  {
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "untyped.ml"});
               Executable
                 ({
                     cs_name = "simply_typed";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "simply-typed.ml"})
            ];
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "T\240\027\235\199\162\1772\1534\234o\004\251\213k";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
